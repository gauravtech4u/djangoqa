...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/home/gaurav/workspace/release/djangoqa/eggs/setuptools-0.6c12dev_r88846-py2.7.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/home/gaurav/workspace/release/djangoqa/eggs/setuptools-0.6c12dev_r88846-py2.7.egg',
        '/home/gaurav/workspace/release/djangoqa/eggs/zc.buildout-1.5.2-py2.7.egg'
        ]
    ...
    original_paths = [
        '/usr/local/lib/python2.7/dist-packages/django_sphinx-2.2.3-py2.7.egg',
        '/usr/lib/pymodules/python2.7',
        '/usr/local/lib/python2.7/dist-packages/pika-0.9.6_pre0-py2.7.egg',
        '/usr/local/lib/python2.7/dist-packages/celery-2.4.6-py2.7.egg',
        '/usr/local/lib/python2.7/dist-packages/xmpppy-0.5.0rc1-py2.7.egg',
        '/usr/local/lib/python2.7/dist-packages/django_celery-2.4.2-py2.7.egg',
